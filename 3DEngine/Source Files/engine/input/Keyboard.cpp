	...
	void Keyboard::UpdateState()
	{
		...
		else
		{
			...
			for(bindsIt = this->binds.begin(); bindsIt != this->binds.end(); bindsIt++)
			{
				...
				if(	(key == "DIK_A" && (bool)(KEYDOWN(kState, DIK_A) != 0)) ||
					(key == "DIK_D" && (bool)(KEYDOWN(kState, DIK_D) != 0)) ||
					(key == "DIK_E" && (bool)(KEYDOWN(kState, DIK_E) != 0)) ||
					(key == "DIK_Q" && (bool)(KEYDOWN(kState, DIK_Q) != 0)) ||
					(key == "DIK_S" && (bool)(KEYDOWN(kState, DIK_S) != 0)) ||
					(key == "DIK_W" && (bool)(KEYDOWN(kState, DIK_W) != 0)) ||
					(key == "DIK_DOWN" && (bool)(KEYDOWN(kState, DIK_DOWN) != 0)) ||
					(key == "DIK_HOME" && (bool)(KEYDOWN(kState, DIK_HOME) != 0)) ||
					(key == "DIK_LEFT" && (bool)(KEYDOWN(kState, DIK_LEFT) != 0)) ||
					(key == "DIK_LSHIFT" && (bool)(KEYDOWN(kState, DIK_LSHIFT) != 0)) ||
					(key == "DIK_RIGHT" && (bool)(KEYDOWN(kState, DIK_RIGHT) != 0)) ||
					(key == "DIK_SPACE" && (bool)(KEYDOWN(kState, DIK_SPACE) != 0)) ||
					(key == "DIK_UP" && (bool)(KEYDOWN(kState, DIK_UP) != 0)))
				{
					// Tell our fans
